...
> - You must be using an up to date tailscale version, this works on both routers and kvm thanks to [Admon](https://github.com/admonstrator/glinet-tailscale-updater/fork): wget -q https://get.admon.me/tailscale -O update-tailscale.sh ; sh update-tailscale.sh
